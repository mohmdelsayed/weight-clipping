...
# 'logs/exp1/input_permuted_mnist/sgd/fcn_relu/lr_0.001',
sgd_grid = GridSearch(
...
# 'logs/exp1/input_permuted_mnist/adam/fcn_relu/lr_0.0001',
...
# 'logs/exp1/input_permuted_mnist/l2_init_sgd/fcn_relu/lr_0.001_weight_decay_0.001',
...
# 'logs/exp1/input_permuted_mnist/l2_init_adam/fcn_relu/lr_0.0001_weight_decay_0.001',
...
# 'logs/exp1/input_permuted_mnist/madam/fcn_relu/lr_0.001_p_scale_5.0',
...
# 'logs/exp1/input_permuted_mnist/shrink_and_perturb_sgd/fcn_relu/lr_0.001_sigma_0.1_weight_decay_0.001',
...
# 'logs/exp1/input_permuted_mnist/shrink_and_perturb_adam/fcn_relu/lr_0.0001_sigma_0.1_weight_decay_0.001',
...
# 'logs/exp1/input_permuted_mnist/weight_clipping_sgd/fcn_relu/lr_0.001_zeta_2.0_clip_last_layer_1.0',
# 'logs/exp1/input_permuted_mnist/weight_clipping_sgd/fcn_relu/lr_0.001_zeta_1.0_clip_last_layer_1.0',
...
# 'logs/exp1/input_permuted_mnist/weight_clipping_adam/fcn_relu/lr_0.0001_zeta_2.0_clip_last_layer_1.0'
# 'logs/exp1/input_permuted_mnist/weight_clipping_adam/fcn_relu/lr_0.0001_zeta_1.0_clip_last_layer_1.0'
...
for learner, grid in zip(learners, grids):
    ...
    create_script_generator(save_dir, exp_name, learner.name, num_jobs, time="200:00:00", memory="5G")
