...
from core.network.fcn_relu import FCNReLU, FCNReLUSmallWithNoBias, FCNReLUSmall, FCNReLUSmallSoftmax, FullyConnectedReLUWithHooks
...
networks = {
    "fcn_relu": FCNReLU,
    "fcn_relu_hooks": FullyConnectedReLUWithHooks,
