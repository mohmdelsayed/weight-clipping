...
class SLRunGeneralization:
    def __init__(self, name='sl_run_generalization', n_epochs=700, task='cifar10', exp_name='exp5', learner='sgd', save_path="logs", seed=0, network='fcn_relu', **kwargs):
        self.name = name
