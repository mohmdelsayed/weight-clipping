...
class CIFAR10:
    def __init__(self, name="cifar10", batch_size=125, is_non_stationary=False, n_epochs=10, n_iteration_per_epoch=400):
...
if __name__ == "__main__":
    ...
    n_epochs = 700
    task = CIFAR10(is_non_stationary=True, n_epochs=n_epochs, n_iteration_per_epoch=n_iteration_per_epoch)
