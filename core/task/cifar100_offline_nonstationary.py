...
class CIFAR100Nonstationary:
    def __init__(self, name="cifar100_nonstationary", batch_size=125, is_non_stationary=True, n_epochs=10, n_iteration_per_epoch=400):
...
if __name__ == "__main__":
    ...
    n_epochs = 700
    task = CIFAR100Nonstationary(is_non_stationary=True, n_epochs=n_epochs, n_iteration_per_epoch=n_iteration_per_epoch)
